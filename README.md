...
**🎉 v1.0.5 - Stable, Secure & Production Ready**
...
```html
<script type="module">
  import { encodeTONL, decodeTONL } from 'https://cdn.jsdelivr.net/npm/tonl@1.0.5/+esm';
...
### UMD (Universal)
```html
<script src="https://unpkg.com/tonl@1.0.5/dist/browser/tonl.umd.js"></script>
<script>
