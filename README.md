...
**🎉 v1.0.4 - Stable, Secure & Production Ready**
...
```html
<script type="module">
  import { encodeTONL, decodeTONL } from 'https://cdn.jsdelivr.net/npm/tonl@1.0.4/+esm';
...
### UMD (Universal)
```html
<script src="https://unpkg.com/tonl@1.0.4/dist/browser/tonl.umd.js"></script>
<script>
